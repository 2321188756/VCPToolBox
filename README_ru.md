...
> Чтобы понять полную логику, стоящую за дизайном, рекомендуется прочитать [речь к официальному релизу VCP 1.0](docs/VCP.md) — там наиболее подробно объясняется, почему каждая система спроектирована именно так.
>
...
**Рекомендуемый бэкенд**: официальные или агрегированные API с поддержкой потокового вывода SSE и стандартизации формата. Ещё раз обратите внимание: **не используйте reverse-proxy или relay API**.  
...
**aio-hub** (дружественный проект): [aio-hub](https://github.com/miaotouy/aio-hub) - более производительный десктопный LLM-чат-клиент на базе Tauri, с частичной нативной API-совместимостью с VCP.
